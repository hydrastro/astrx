...
reference). Deferred refinements: robots.txt fetching in-loop, conditional GET,
media-hash blocking, jitter, the scheduled-reseed daemon, and the opt-in `tls`
