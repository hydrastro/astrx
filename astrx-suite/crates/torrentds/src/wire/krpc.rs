...
/// A bencode dict (the `a` args and `r` response payloads). Defined in
/// [`crate::bencode`] — the bencode data model — and re-exported here for the many
/// KRPC call sites that build one.
pub use crate::bencode::Dict;
