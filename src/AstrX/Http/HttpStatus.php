 ...
 *
 * Using an enum instead of a final class with constants gives you:
 * - Exhaustive matching in match expressions
 * - Type safety (you can type-hint HttpStatus instead of int)
 * - Built-in from()/tryFrom() for safe construction
 *
 * The static isValid() helper is kept for raw-int compatibility at
 * framework boundaries (e.g. Response::__construct).
 */
enum HttpStatus: int
{
    case CONTINUE                        = 100;
    ...
    /** Accept any raw int in the valid HTTP range (used by Response for back-compat). */
