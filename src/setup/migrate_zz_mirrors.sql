...
-- Both pages belong to the independently-toggleable 'mirrors' module. Tagged here
...
UPDATE `page` SET `module` = 'mirrors'
 WHERE `module` = '' AND `file_name` IN ('mirrors', 'admin_mirrors');
